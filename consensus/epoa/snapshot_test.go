...
func (r *testerChainReader) Config() *params.ChainConfig                 { return params.AllEpoaProtocolChanges }
...
func TestVoting(t *testing.T) {
	...
	for i, tt := range tests {
		...
		// Pass all the headers through epoa and ensure tallying succeeds
		head := headers[len(headers)-1]

		snap, err := New(&params.EpoaConfig{Epoch: tt.epoch}, db).snapshot(&testerChainReader{db: db}, head.Number.Uint64(), head.Hash(), headers)
		if err != nil {
