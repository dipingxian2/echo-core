...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 3. Epoa - proof-of-authority, randomly produce block")
	...
	case choice == "3":
		// In the case of clique, configure the consensus parameters
		genesis.Difficulty = big.NewInt(1)
		genesis.Config.Epoa = &params.EpoaConfig{
			Period: 15,
			Epoch:  30001,
		}
		fmt.Println()
		fmt.Println("How many seconds should blocks take? (default = 15)")
		genesis.Config.Epoa.Period = uint64(w.readDefaultInt(15))
